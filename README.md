...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-adminlte-1742234816) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-adminlte-1742234816.git
$ cd django-adminlte-1742234816
```
